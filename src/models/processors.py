## This code snippet was taken from the following source to reduce dependencies on external libraries:
        ...
        for message in conversation:
            if isinstance(message["content"], list):
                ...
                if (
                    ...
                    or "image_url" in message["content"]
                    or "video" in message["content"]
                    or message["content"]["type"] in ("image", "image_url", "video")
                ):
                    vision_infos.append(message["content"])
    return vision_infos
